...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Flutter小样程序主页'),
      routes: {
...
class SecondRoute extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      }, child: Text("打开固定内容页"), color: Colors.deepOrange, textColor: Colors.white,),
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () {
//                Navigator.pop(context, "给你坨翔");
              Navigator.pushNamed(context, "second_page");
              },
            ),
            FlatButton(
              child: Text("close this routePage"),
              textColor: Colors.deepOrange,
              onPressed: () {
                Navigator.pop(context, "给你坨翔");
//              Navigator.pushNamed(context, "second_page");
  ...
  void _incrementCounter() {
    setState(() {
      ...
      Future.delayed(new Duration(seconds: 2), () {
        if (_counter == 5) {
          throw AssertionError("ops! Error");
        }
        return "点击了";
      }).then((data) {
        //执行成功会走到这里
